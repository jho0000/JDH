        ...
        <main>
            ...
            <section class="page col-7">
                ...
                <div class="analysis">
                    ...
                    <img class="asset" src="/img/Moments/Algorithm.png" alt="YouTube Music and Spotify algorithmic recommendations"></img>
                ...
                <div class="design-process">
                    ...
                    <div class="lofi-prototype">
                        ...
                        <img class="asset" src="/img/Moments/WF1.gif" alt="Low-fidelity prototype GIF of exploring local map page posts"></img>
                        <p class="caption">Exploring local map page posts</p>
                        <img class="asset" src="/img/Moments/WF2.gif" alt="Low-fidelity prototype GIF of selecting a song to drop a Moment"></img>
                        <p class="caption">Selecting a song to drop a Moment</p>
                        <img class="asset" src="/img/Moments/WF3.gif" alt="Low-fidelity prototype GIF of a notifications page and exploring a profile"></img>
                    ...
                    <div>
                        ...
                        <img class="asset" src="/img/Moments/WF4.png" alt="Low-fidelity prototype image of duplicate icons"></img>
                    ...
                    <div class="hifi-prototype">
                        ...
                        <img class="asset" src="/img/Moments/MF1.gif" alt="High-fidelity prototype GIF of exploring a post’s location and profile"></img>
                        <p class="caption">Exploring a post’s location and profile</p>
                        <img class="asset" src="/img/Moments/MF2.gif" alt="High-fidelity prototype GIF of editing profile and followers list"></img>
                        <p class="caption">Editing profile and followers list</p>
                        <img class="asset" src="/img/Moments/MF3.gif" alt="High-fidelity prototype GIF of dropping a Moment on the map"></img>
                    ...
                    <div>
                        ...
                        <img class="asset" src="/img/Moments/HF1.gif" alt="Home map page"></img>
                        <p class="caption">Home map page</p>
                        <img class="asset" src="/img/Moments/HF2.gif" alt="Exploring someone’s Moment and profile"></img>
                        <p class="caption">Exploring someone’s Moment and profile</p>
                        <img class="asset" src="/img/Moments/HF3.gif" alt="Viewing an active Moment on the Moments page"></img>
                        <p class="caption">Viewing an active Moment on the Moments page</p>
                        <img class="asset" src="/img/Moments/HF4.gif" alt="Dropping a Moment at my current location"></img>
